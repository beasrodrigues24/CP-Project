...
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{x}\;\Varid{y})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{x},\Varid{y})))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{x})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{x}))){}\<[E]%
\\[\blanklineskip]%
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\underline{\Varid{a}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\alt{\Varid{h}}{\Varid{j}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{b})\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{j}\mathrel{=}\alt{\Varid{k}}{\Varid{l}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Sum},(\Varid{z},\Varid{w}))\mathrel{=}\Varid{z}\mathbin{+}\Varid{w}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Product},(\Varid{z},\Varid{w}))\mathrel{=}\Varid{z}\mathbin{*}\Varid{w}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{l}\;(\Conid{Negate},\Varid{z})\mathrel{=}\mathbin{-}\Varid{z}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{l}\;(\Conid{E},\Varid{z})\mathrel{=}\Varid{expd}\;\Varid{z}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{x}\;\Varid{y})\mid \Varid{x}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{outExpAr}\;(\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{y}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{outExpAr}\;(\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}\Varid{outExpAr}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{x}\;\Varid{y})\mid \Varid{x}\not\equiv (\Conid{N}\;\mathrm{0})\mathrel{\wedge}\Varid{y}\not\equiv (\Conid{N}\;\mathrm{0}){}\<[53]%
\>[53]{}\mathrel{=}\Varid{outExpAr}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}\Varid{outExpAr}\;(\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{x})\mid \Varid{x}\not\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{outExpAr}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}\Varid{outExpAr}\;(\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{E}\;\Varid{x})\mid \Varid{x}\not\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{outExpAr}\;(\Conid{Un}\;\Conid{E}\;\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{16}{}\<[16]%
\>[16]{}\mid \Varid{otherwise}\mathrel{=}\Varid{outExpAr}\;(\Conid{N}\;\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;\Varid{exp}\mathrel{=}\Varid{outExpAr}\;\Varid{exp}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{gopt}\;\Varid{a}\mathrel{=}\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\underline{\Varid{a}}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Sum},(\Varid{z},\Varid{w}))\mid \Varid{z}\equiv \mathrm{0}\mathrel{\wedge}\Varid{w}\equiv \mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[9]{}\hsindent{14}{}\<[23]%
\>[23]{}\mid \Varid{otherwise}\mathrel{=}\Varid{z}\mathbin{+}\Varid{w}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Product},(\Varid{z},\Varid{w}))\mathrel{=}\Varid{z}\mathbin{*}\Varid{w}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{l}\;(\Conid{E},\Varid{z})\mid \Varid{z}\equiv \mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[9]{}\hsindent{8}{}\<[17]%
\>[17]{}\mid \Varid{otherwise}\mathrel{=}\Varid{expd}\;\Varid{z}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\left\{
   \begin{array}{lll}
       \ensuremath{\Varid{out}\comp \Conid{X}\mathrel{=}i_1}\\
       \ensuremath{\Varid{out}\comp [\mskip1.5mu \Conid{N},\Varid{ops}\mskip1.5mu]\mathrel{=}i_2}
   \end{array}
\right.
%
...
\left\{
   \begin{array}{lll}
       ...
       \ensuremath{\Varid{out}\comp [\mskip1.5mu \Varid{bin},\Conid{Uncurry}\;\Conid{Un}\mskip1.5mu]\mathrel{=}i_2\comp i_2}
   \end{array}
\right.
%
...
\left\{
   \begin{array}{lll}
       ...
       \ensuremath{\Varid{out}\comp \Conid{Uncurry}\;\Conid{Un}\mathrel{=}i_2\comp i_2\comp i_2}
   \end{array}
\right.
%
...
\left\{
   \begin{array}{lll}
       ...
       \ensuremath{\Varid{out}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_2\;(i_1\;\Varid{a})}\\
       \ensuremath{\Varid{out}\;(\Varid{bin}\;(\Varid{op},(\Varid{x},\Varid{y})))\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{x},\Varid{y}))))}\\
       \ensuremath{\Varid{out}\;(\Conid{Uncurry}\;\Conid{Un}\;(\Varid{op},\Varid{x}))\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{x})))}
   \end{array}
\right.
%
...
\left\{
   \begin{array}{lll}
       \ensuremath{\Varid{out}\;\Conid{X}\mathrel{=}i_1\;()}\\
       \ensuremath{\Varid{out}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_2\;(i_1\;\Varid{a})}\\
       \ensuremath{\Varid{out}\;(\Conid{Bin}\;\Varid{op}\;\Varid{x}\;\Varid{y})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{x},\Varid{y}))))}\\
       \ensuremath{\Varid{out}\;(\Conid{Un}\;\Varid{op}\;\Varid{x})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{x})))}
   \end{array}
\right.
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{cataExpAr}\;\Varid{gene}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\Conid{ExpAr}\;\Varid{a}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{C}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a}))}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{cataExpAr}\;\Varid{gene})}}
           \ar[l]_-{\ensuremath{\Varid{inExpAr}}}
\\
     \ensuremath{\Conid{B}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\Conid{E}\;\Conid{X}\;\Conid{E})\mathbin{+}\Conid{C}\;\Conid{X}\;\Conid{E}))}
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Expr}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{cataExpAr}\;\Varid{g\char95 eval\char95 exp}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\Conid{Expr}\;\Varid{a}\;\Conid{X}\;(\Conid{Expr}\;\Varid{a})\mathbin{+}\Conid{C}\;\Conid{X}\;\Conid{Expr}\;\Varid{a}))}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{cataExpAr}\;\Varid{g\char95 eval\char95 exp})}}
           \ar[l]_-{\ensuremath{\Varid{inExpAr}}}
\\
     \ensuremath{\N_0}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\N_0,\N_0)\mathbin{+}\Conid{C}\;\Conid{X}\;\N_0))}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{anaExpAr}\;\Varid{clean}}}
           \ar[r]_- {\ensuremath{\Varid{clean}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\Conid{ExpAr}\;\Varid{a}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{C}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a}))}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{anaExpAr}\;\Varid{clean})}}
\\
     \ensuremath{\Conid{ExpAr}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{cataExpAr}\;\Varid{gopt}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\Conid{ExpAr}\;\Varid{a}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{C}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a}))}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{cataExpAr}\;\Varid{gopt})}}
           \ar[l]^-{\ensuremath{\Varid{inExpAr}}}
\\ 
     \ensuremath{\N_0}
& 
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\N_0\;\Conid{X}\;\N_0)\mathbin{+}\Conid{C}\;\Conid{X}\;\N_0))}
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\underline{(\Conid{X},\Conid{N}\;\mathrm{1})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\alt{\Varid{h}}{\Varid{j}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{a})\mathrel{=}(\Conid{N}\;\Varid{a},\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{j}\mathrel{=}\alt{\Varid{k}}{\Varid{l}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Sum},((\Varid{z},\Varid{w}),(\Varid{x},\Varid{y})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{z}\;\Varid{x},\Conid{Bin}\;\Conid{Sum}\;\Varid{w}\;\Varid{y}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Product},((\Varid{z},\Varid{w}),(\Varid{x},\Varid{y})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{z}\;\Varid{x},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{z}\;\Varid{y})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{w}\;\Varid{x})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{l}\;(\Conid{Negate},(\Varid{z},\Varid{w}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{z},\Conid{Un}\;\Conid{Negate}\;\Varid{w}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{l}\;(\Conid{E},(\Varid{z},\Varid{w}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{z},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{z})\;\Varid{w}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{cataExpAr}\;\Varid{sd\char95 gen}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\Conid{ExpAr}\;\Varid{a}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{C}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a}))}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{cataExpAr}\;\Varid{sd\char95 gen})}}
           \ar[l]_-{\ensuremath{\Varid{inExpAr}}}
\\
     \ensuremath{\Conid{ExpAr}\;\Varid{a}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a}}
&
     \ensuremath{\Varid{expr}}
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}\mathrel{=}\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\underline{(\Varid{a},\mathrm{1})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\alt{\Varid{h}}{\Varid{j}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{b})\mathrel{=}(\Varid{b},\mathrm{0}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{j}\mathrel{=}\alt{\Varid{k}}{\Varid{l}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Sum},((\Varid{z},\Varid{w}),(\Varid{x},\Varid{y})))\mathrel{=}(\Varid{z}\mathbin{+}\Varid{x},\Varid{w}\mathbin{+}\Varid{y}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(\Conid{Product},((\Varid{z},\Varid{w}),(\Varid{x},\Varid{y})))\mathrel{=}(\Varid{z}\mathbin{*}\Varid{x},\Varid{z}\mathbin{*}\Varid{y}\mathbin{+}\Varid{w}\mathbin{*}\Varid{x}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{l}\;(\Conid{Negate},(\Varid{z},\Varid{w}))\mathrel{=}(\mathbin{-}\Varid{z},\mathbin{-}\Varid{w}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{l}\;(\Conid{E},(\Varid{z},\Varid{w}))\mathrel{=}(\Varid{expd}\;\Varid{z},\Varid{w}\mathbin{*}\Varid{expd}\;\Varid{z}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{cataExpAr}\;\Varid{ad\char95 gen}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;(\Conid{ExpAr}\;\Varid{a}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{C}\;\Conid{X}\;\Conid{ExpAr}\;\Varid{a}))}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{cataExpAr}\;\Varid{ad\char95 gen})}}
           \ar[l]_-{\ensuremath{\Varid{inExpAr}}}
\\
     \ensuremath{\N_0\;\Conid{X}\;\N_0}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{B}\;\Conid{X}\;((\N_0,\N_0)\;\Conid{X}\;(\N_0,\N_0))\mathbin{+}\Conid{C}\;\Conid{X}\;(\N_0,\N_0)))}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{tot},\Varid{up},\Varid{down},\Varid{up\char95 inc},\Varid{down\char95 inc}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}(\Varid{up}\div \Varid{down},\Varid{up}\mathbin{*}(\Varid{up\char95 inc}\mathbin{+}\mathrm{1})\mathbin{*}\Varid{up\char95 inc},\Varid{down}\mathbin{*}(\Varid{down\char95 inc}\mathbin{+}\mathrm{1})\mathbin{*}\Varid{down\char95 inc},\Varid{up\char95 inc}\mathbin{+}\mathrm{2},\Varid{down\char95 inc}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{1},\mathrm{1},\mathrm{3},\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d},\Varid{e})\mathrel{=}\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h}\mathrel{=}\alt{\Varid{i}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{i}\;\Varid{l}\mathrel{=}\underline{\Varid{nil}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{g}\mathbin{::}(\Q ,\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint})\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;([\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \Varid{p}\mskip1.5mu]\mathrel{=}i_1\;(\Varid{p}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;\Varid{l}\mathrel{=}i_2\;(\Varid{init}\;\Varid{l},\Varid{tail}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{alg}\mathrel{=}\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{f}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{f}\;\Varid{p}\mathrel{=}\underline{\Varid{p}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{g}\;((\Varid{op1},\Varid{op2}))\mathrel{=}\lambda \Varid{pt}\to (\Varid{calcLine}\;(\Varid{op1}\;\Varid{pt})\;(\Varid{op2}\;\Varid{pt}))\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{NPoint}}
           \ar[d]_-{\ensuremath{\Varid{cataList}\;\Varid{h}}}
           \ar[r]_-{\ensuremath{\Varid{outList}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{Q}\;\Conid{X}\;\Conid{NPoint}}
           \ar[d]^{\ensuremath{\Varid{recList}\;(\Varid{cataList}\;\Varid{h})}}
\\
     \ensuremath{\Conid{NPoint}\to \Conid{Overtime}\;\Conid{NPoint}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{Q}\;\Conid{X}\;(\Conid{NPoint}\to \Conid{Overtime}\;\Conid{NPoint})}
...
\xymatrix@C=2cm{
    \ensuremath{[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]}
           \ar[d]_-{\ensuremath{\mathopen{[\!(}\Varid{coalg}\mathclose{)\!]}}}
           \ar[r]_-{\ensuremath{\Varid{coalg}}}
&
    \ensuremath{\Conid{NPoint}\mathbin{+}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\;\Conid{X}\;[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]}
           \ar[d]^-{\ensuremath{\Varid{recLTree}\;\mathopen{[\!(}\Varid{coalg}\mathclose{)\!]}}}
\\
    \ensuremath{\mathsf{LTree}\;\Conid{NPoint}}
           \ar[d]_-{\ensuremath{\llparenthesis\, \Varid{alg}\,\rrparenthesis}}
           \ar[r]_-{\ensuremath{\Varid{out}}}
&
    \ensuremath{\Conid{NPoint}\mathbin{+}\mathsf{LTree}\;\Conid{NPoint}\;\Conid{X}\;\mathsf{LTree}\;\Conid{NPoint}}
           \ar[d]^-{\ensuremath{\Varid{recLTree}\;\llparenthesis\, \Varid{alg}\,\rrparenthesis}}
\\
    \ensuremath{\Conid{Overtime}\;\Conid{NPoint}}      
&
    \ensuremath{\Conid{NPoint}\mathbin{+}\Conid{Overtime}\;\Conid{NPoint}\;\Conid{X}\;\Conid{Overtime}\;\Conid{NPoint}}
          \ar[l]_-{\ensuremath{\Varid{alg}}}
}
\end{eqnarray*}
...
\column{12}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inNEmpList}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outNEmpList}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;(\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{outNEmpList}\;(\Varid{a}\mathbin{:}\Varid{x})\mathrel{=}i_2\;(\Varid{a},\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recNEmpList}\;\Varid{f}\mathrel{=}\Varid{id}+\Varid{id}\times\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataNEmpList}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recNEmpList}\;(\Varid{cataNEmpList}\;\Varid{g})\comp \Varid{outNEmpList}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataNEmpList}\;(\Varid{gene}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{gene}\mathrel{=}\alt{\Varid{b}}{\Varid{q}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{q}{}\<[12]%
\>[12]{}\mathrel{=}\conj{\Varid{avg}}{\length }{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{avg}\;(\Varid{a},(\Varid{x},\Varid{y}))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{x}\mathbin{*}\Varid{y})\mathbin{/}(\Varid{y}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\length \;(\anonymous ,(\anonymous ,\Varid{y}))\mathrel{=}\Varid{y}\mathbin{+}\mathrm{1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\;\Conid{X}\;[\mskip1.5mu \Conid{A}\mskip1.5mu]}
           \ar[d]^{\ensuremath{\Varid{recNEmpList}\;\cata{\Varid{gene}}}}
           \ar[l]_-{\ensuremath{\Varid{inList}}}
\\
     \ensuremath{\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\;\Conid{X}\;(\Conid{A},\Conid{N})}
           \ar[l]^-{\ensuremath{\Varid{gene}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{gene}\mathrel{=}\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{f}\mathrel{=}\conj{\Varid{id}}{\underline{\mathrm{1}}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\conj{\Varid{avg}}{\length }{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{avg}\;((\Varid{x},\Varid{y}),(\Varid{z},\Varid{w}))\mathrel{=}(\Varid{x}\mathbin{*}\Varid{y}\mathbin{+}\Varid{z}\mathbin{*}\Varid{w})\mathbin{/}(\Varid{y}\mathbin{+}\Varid{w}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\length \;((\anonymous ,\Varid{y}),(\anonymous ,\Varid{w}))\mathrel{=}\Varid{y}\mathbin{+}\Varid{w}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;\mathsf{LTree}\;\Varid{a}\mathrel{=}\Conid{Leaf}\;\Varid{a}\mid \Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
.
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\cata{\Varid{gene}}}}
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{Ltree}\;\Varid{a}\;\Conid{X}\;\mathsf{LTree}\;\Varid{a}}
           \ar[d]^{\ensuremath{\Varid{recLTree}\;\cata{\Varid{gene}}}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}(\Conid{A},\Conid{N})\;\Conid{X}\;(\Conid{A},\Conid{N})}
           \ar[l]^-{\ensuremath{\Varid{gene}}}
}
\end{eqnarray*}
